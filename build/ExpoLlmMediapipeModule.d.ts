...
BaseLlmReturn, DownloadableLlmReturn, UseLLMAssetProps, UseLLMFileProps, UseLLMDownloadableProps, PromptOrInput } from "./ExpoLlmMediapipe.types";
 ...
 */
export declare function generateStreamingText(modelHandle: number, input: PromptOrInput, onPartialResponse?: (text: string, requestId: number) => void, onError?: (error: string, requestId: number) => void, abortSignal?: AbortSignal): Promise<void>;

...
export interface ExpoLlmMediapipeModule {
     ...
     * @returns A promise that resolves to a boolean indicating success or failure.
     */
    downloadModel(url: string, modelName: string, options?: DownloadOptions): Promise<boolean>;
    /**
     ...
     * @returns A promise that resolves to the model handle.
     */
    createModelFromDownloaded(modelName: string, maxTokens?: number, topK?: number, temperature?: number, randomSeed?: number): Promise<number>;
    /**
     ...
     */
    addListener<EventName extends keyof ExpoLlmMediapipeModuleEvents>(eventName: EventName, listener: ExpoLlmMediapipeModuleEvents[EventName]): NativeModuleSubscription;
    /**
...
export {};
//# sourceMappingURL=ExpoLlmMediapipe.types.d.ts.map